    ...
    public function up(Schema $schema): void
    {
        $this->addSql('
            CREATE TABLE affectation_match (
                ...
                INDEX IDX_AM_RENCONTRE (rencontre_id),
                INDEX IDX_AM_USER (user_id),
                INDEX IDX_AM_STATUT (statut),
                PRIMARY KEY (id)
        ...
        $this->addSql('
            ALTER TABLE affectation_match
                ADD CONSTRAINT FK_AM_RENCONTRE FOREIGN KEY (rencontre_id) REFERENCES rencontre (id) ON DELETE CASCADE,
                ADD CONSTRAINT FK_AM_USER FOREIGN KEY (user_id) REFERENCES user (id) ON DELETE SET NULL
        ');
    }

    public function down(Schema $schema): void
    {
        $this->addSql('ALTER TABLE affectation_match DROP FOREIGN KEY FK_AM_RENCONTRE');
        $this->addSql('ALTER TABLE affectation_match DROP FOREIGN KEY FK_AM_USER');
