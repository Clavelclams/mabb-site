    ...
    public function up(Schema $schema): void
    {
        $this->addSql(<<<'SQL'
            CREATE TABLE document (
                ...
                titre           VARCHAR(255)  NOT NULL          COMMENT 'Titre affiché dans l'ENT',
                ...
                description     LONGTEXT      NULL              COMMENT 'Description/instructions optionnelles',
                nom_original    VARCHAR(255)  NOT NULL          COMMENT 'Nom original du fichier (affiché dans l'UI)',
                path            VARCHAR(255)  NOT NULL          COMMENT 'Chemin relatif : {uniqid}.{ext} dans uploads/ent/{clubId}/',
                mime_type       VARCHAR(100)  NOT NULL          COMMENT 'MIME type validé à l'upload',
