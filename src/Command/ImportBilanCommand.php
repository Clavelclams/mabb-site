...
class ImportBilanCommand extends Command
{
    ...
    private const BILANS_DATA = [
        ...
        [
            'nom'    => 'Guelfat',
            'prenom' => 'Maissa',   // Correction : ce bilan appartient à Maissa, sœur de Chaineze
            'saison' => '2025-2026',
            'contexte' => 'Camp d\'entraînement',
            'date_evaluation' => '2026-06-04',
            'statut' => 'brouillon',
        ...
        [
            'nom'    => 'Milapie',
            'prenom' => 'Cler-mirice',
            'saison' => '2023-2024',   // Correction : camp octobre 2023 → saison 2023-2024
            'contexte' => 'Camp d\'entraînement',
            'date_evaluation' => '2023-10-20',
            'statut' => 'valide',
